                        ...
                        <tr>
                            <td id='input'>
                                ...
                                airportsOrigin.map((airport) => {
                                    return <button key={airport.AirportCode} value={airport.AirportCode} onClick={setOriginAirport}>{airport.AirportName} {airport.AirportCode}</button>
                                }) : <div></div>    
                                }
                            </td>
                            <td></td>
                            <td id='input'>
                                ...
                                airportsDest.map((airport) => {
                                    return <button key={airport.AirportCode} value={airport.AirportCode} onClick={setDestAirport}>{airport.AirportName} {airport.AirportCode}</button>
                                }) : <div></div>
                                }
                            </td>
                            <td></td>
